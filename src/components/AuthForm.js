...
export default function AuthForm({ registerUserAction, initialMessage, isError, callbackUrl }) {
        ...
        <div style={{ display: activeTab === "register" ? "block" : "none" }}>
          <form onSubmit={handleRegister} noValidate>
            <div className={styles.inputGroup}>
              ...
              <input type="text" id="register-name" name="name" required disabled={isPending} />
            </div>
            <div className={styles.inputGroup}>
              <label htmlFor="register-email">Email</label>
              <input type="email" id="register-email" name="email" required disabled={isPending} />
            </div>
            <div className={styles.inputGroup}>
        ...
        <div style={{ display: activeTab === "login" ? "block" : "none" }}>
          ...
          <form onSubmit={handleLogin} noValidate>
            <div className={styles.inputGroup}>
              ...
              <input type="email" id="login-email" name="email" required disabled={isPending} />
            </div>
            <div className={styles.inputGroup}>
