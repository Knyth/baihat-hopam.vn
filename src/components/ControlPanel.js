    ...
    return (
      <>
        <div className="toolbar-group">
          <button className="control-button" onClick={() => onTranspose(-1)}>
            -
          </button>
          <span className="current-key" style={{ minWidth: 40, textAlign: "center" }}>
            {current_key}
          </span>
          <button className="control-button" onClick={() => onTranspose(1)}>
            +
        ...
        <div className="toolbar-group">
          <button className="control-button" onClick={() => onFontSizeChange(-2)}>
            A-
          </button>
          <span className="current-key" style={{ minWidth: 44, textAlign: "center" }}>
            {fontSize}px
          </span>
          <button className="control-button" onClick={() => onFontSizeChange(2)}>
            A+
