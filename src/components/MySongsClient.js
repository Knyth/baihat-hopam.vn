  ...
  return (
    <div className="favorite-song-item">
      <div className="song-info">
        ...
        <p className="song-composer">
          {song.composer ? song.composer.name : 'Không rõ'}
        </p>
      </div>
  ...
  if (songs.length === 0) {
    return (
      <div className="empty-state-container">
        ...
        <p>Hãy bắt đầu khám phá và nhấn vào biểu tượng ❤️ tại bất kỳ bài hát nào bạn thích để lưu lại đây nhé.</p>
