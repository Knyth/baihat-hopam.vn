    ...
    <form action="/search" method="get" className={styles.searchWrap}>
      ...
      <button type="submit" className={styles.iconBtn} aria-label="Tìm kiếm" title="Tìm kiếm">
        <svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true">
          <path
            fill="currentColor"
            d="M15.5 14h-.79l-.28-.27A6.471 6.471 0 0 0 16 9.5 6.5 6.5 0 1 0 9.5 16a6.471 6.471 0 0 0 4.23-1.57l.27.28v.79L20 21.5 21.5 20 15.5 14ZM9.5 14A4.5 4.5 0 1 1 14 9.5 4.505 4.505 0 0 1 9.5 14Z"
          />
        </svg>
      </button>
    </form>
